...
export class ServiceService {
  ...
  postGain(uid:any,nom:any,description:any){
    ...
    return this.http.post(this.baseUri+'/addgain/'+uid+'/'+nom+'/'+description,{'headers':headers});
  }
  ...
  postEtat_P(uid:any){
    const headers = { 'content-type': 'application/json'} 
       return this.http.put(this.baseUri+'/updateEtat/'+uid,{'headers':headers})
  }
  search(){
  ...
  update_etatObtention(uid:any){ 
    const headers = { 'content-type': 'application/json'} 
    return this.http.put(this.baseUri+'/UpdateEtatobtention/'+uid,{'headers':headers})
  }
  update_etatRepond(uid:any){ 
    const headers = { 'content-type': 'application/json'} 
    return this.http.put(this.baseUri+'/UpdateEtatRepond/'+uid,{'headers':headers})
  }
  ...
  Subscribed(email:any){
    const headers = { 'content-type': 'application/json'} 
       return this.http.post(this.baseUri+'/EmailChimp/'+email,{'headers':headers})
  }
  addticketUser(uid:any,ticket:any){
    const headers = { 'content-type': 'application/json'} 
    return this.http.post(this.baseUri+'/addticketUser/'+uid+'/'+ticket,{'headers':headers})
  }
  addtotaltciket(nombreT:any){
    const headers = { 'content-type': 'application/json'} 
       return this.http.post(this.baseUri+'/AddticketR/'+nombreT,{'headers':headers})
  }
}
