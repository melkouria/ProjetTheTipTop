    ...
    stages {
        ...
        stage('Deploy to GKE') {
            steps{
                ...
                step([$class: 'KubernetesEngineBuilder', project: env.PROJECT_ID, clusters: env.CLUSTER_NAME, region: env.LOCATION, manifestPattern: 'deployment.yaml', credentialsId: env.CREDENTIALS_ID, verifyDeployments: true])
                 }
